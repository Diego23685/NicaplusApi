...
namespace NicaplusApi.Migrations
{
    ...
    [Migration("20260827210837_TasaCambio1")]
    partial class TasaCambio1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NicaplusApi.Models.CodigoDigital", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NicaplusApi.Models.PerfilCuenta", b =>
                {
                    ...
                    b.Property<string>("AccountGroupKey")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("NicaplusApi.Models.TasaDeCambio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NicaplusApi.Models.VariacionProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VariacionesProductos");
                });
            ...
            modelBuilder.Entity("NicaplusApi.Models.CodigoDigital", b =>
                {
                    ...
                    b.HasOne("NicaplusApi.Models.VariacionProducto", "Variacion")
                        .WithMany()
            ...
            modelBuilder.Entity("NicaplusApi.Models.MovimientoCaja", b =>
                {
                    ...
                    b.HasOne("NicaplusApi.Models.Renovacion", "Renovacion")
                        .WithMany()
                        .HasForeignKey("IdRenovacion");
            ...
            modelBuilder.Entity("NicaplusApi.Models.VariacionProducto", b =>
                {
                    b.HasOne("NicaplusApi.Models.Producto", "ProductoPadre")
